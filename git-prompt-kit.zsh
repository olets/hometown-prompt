...
GIT_PROMPT_KIT_GIT_FILES_ON_TWO_LINES=${GIT_PROMPT_KIT_GIT_FILES_ON_TWO_LINES:-1}
GIT_PROMPT_KIT_GIT_REF_ON_CWD_LINE=${GIT_PROMPT_KIT_GIT_REF_ON_CWD_LINE:-1}
...
GIT_PROMPT_KIT_SYMBOL_ADDED=${GIT_PROMPT_KIT_SYMBOL_ADDED-??}
GIT_PROMPT_KIT_SYMBOL_ADDED_STAGED=${GIT_PROMPT_KIT_SYMBOL_ADDED_STAGED-A_}
...
GIT_PROMPT_KIT_COLOR_ACTIVE_STAGED=${GIT_PROMPT_KIT_COLOR_ACTIVE_STAGED:-2}
GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED=${GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED:-1}
...
GIT_PROMPT_KIT_COLOR_FAIL=${GIT_PROMPT_KIT_COLOR_FAIL:-196}
...
GIT_PROMPT_KIT_COLOR_SUCCESS=${GIT_PROMPT_KIT_COLOR_SUCCESS:-76}
GIT_PROMPT_KIT_COLOR_TAG=${GIT_PROMPT_KIT_COLOR_TAG:-140}
GIT_PROMPT_KIT_COLOR_USER=${GIT_PROMPT_KIT_COLOR_USER:-109}
GIT_PROMPT_KIT_COLOR_WHERE=${GIT_PROMPT_KIT_COLOR_WHERE:-140}
...
function _git_prompt_kit_update_git() {
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_UNTRACKED )); then
    ...
    (( VCS_STATUS_NUM_UNTRACKED )) && GIT_PROMPT_KIT_ADDED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED}$VCS_STATUS_NUM_UNTRACKED" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_CONFLICTED )); then
    ...
    (( VCS_STATUS_NUM_CONFLICTED )) && GIT_PROMPT_KIT_CONFLICTED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED}$VCS_STATUS_NUM_CONFLICTED" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_UNSTAGED_DELETED )); then
    ...
    (( VCS_STATUS_NUM_UNSTAGED_DELETED )) && GIT_PROMPT_KIT_DELETED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED}$VCS_STATUS_NUM_UNSTAGED_DELETED" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || unstaged_count )); then
    ...
    (( $unstaged_count )) && GIT_PROMPT_KIT_MODIFIED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_UNSTAGED}$unstaged_count" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_STAGED_NEW )); then
    ...
    (( VCS_STATUS_NUM_STAGED_NEW )) && GIT_PROMPT_KIT_ADDED_STAGED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_STAGED}$VCS_STATUS_NUM_STAGED_NEW" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_STAGED_DELETED )); then
    ...
    (( VCS_STATUS_NUM_STAGED_DELETED )) && GIT_PROMPT_KIT_DELETED_STAGED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_STAGED}$VCS_STATUS_NUM_STAGED_DELETED" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || added_staged_count )); then
    ...
    (( added_staged_count )) && GIT_PROMPT_KIT_MODIFIED_STAGED+="%F{$GIT_PROMPT_KIT_COLOR_ACTIVE_STAGED}$added_staged_count" && dirty=1
  ...
  if (( dirty )); then
    GIT_PROMPT_KIT_HEAD+="%F{$GIT_PROMPT_KIT_COLOR_WHERE}"
  else
  ...
  if (( GIT_PROMPT_KIT_SET_PROMPT )); then
    ...
    if ! (( GIT_PROMPT_KIT_GIT_FILES_ON_TWO_LINES )); then
      ref_status+="$tree_status"
      ref_status+="$action_status%f"
    fi

    if (( GIT_PROMPT_KIT_GIT_REF_ON_CWD_LINE )); then
