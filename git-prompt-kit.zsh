...
function _git_prompt_kit_update_git() {
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_UNTRACKED )); then
    ...
    (( VCS_STATUS_NUM_UNTRACKED )) && GIT_PROMPT_KIT_ADDED+="%F{$GIT_PROMPT_KIT_COLOR_UNSTAGED}$VCS_STATUS_NUM_UNTRACKED" && dirty=1
  ...
  if (( GIT_PROMPT_KIT_SHOW_INACTIVE_STATUS || VCS_STATUS_NUM_STAGED_NEW )); then
    ...
    (( VCS_STATUS_NUM_STAGED_NEW )) && GIT_PROMPT_KIT_ADDED_STAGED+="%F{$GIT_PROMPT_KIT_COLOR_STAGED}$VCS_STATUS_NUM_STAGED_NEW" && dirty=1
